...
public class MasteryTaskTwoTests {
    ...
    public void generateAdvertisement_withTargetCustomerIdInMarketplace_returnsAdvertisement() {
        ...
        System.out.println(String.format("GenerateAdvertisement request took %s milliseconds to complete, " +
                "expected less than %s ms. GenerateAdvertisement should " +
                "evaluate predicates concurrently!", elapsed, CONCURRENT_APPROXIMATE_EXECUTION_DURATION));
